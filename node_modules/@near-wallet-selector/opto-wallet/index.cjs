...
const setupWalletState = (params, network) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const wallet = new nearApiJs.WalletConnection(near, "near_app");
  return {
    wallet,
    keyStore
  };
...
function setupOptoWallet({
  ...
  return () => __awaiter(this, void 0, void 0, function* () {
    ...
    return {
      ...
      init: options => {
        return OptoWallet(Object.assign(Object.assign({}, options), {
          params: {
...
exports.setupOptoWallet = setupOptoWallet;
