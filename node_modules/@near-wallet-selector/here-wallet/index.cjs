  ...
  return {
    ...
    signIn(data) {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const account = yield here.signIn(data);
    ...
    getAccounts() {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const accounts = yield here.getAccounts();
    ...
    signMessage({
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield here.signMessage({
          signerId: signerId !== null && signerId !== void 0 ? signerId : yield here.getAccountId(),
          message
        });
      });
    },
