...
const proxyProvider = (conf) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    let { strategy, network, disableCleanupRequest, id, transactions = [], signal } = conf, delegate = __rest(conf, ["strategy", "network", "disableCleanupRequest", "id", "transactions", "signal"]);
    if (id != null) {
        const request = yield (0, methods_1.getRequest)(id, signal);
        transactions = request.transactions;
        network = (_b = (_a = request.network) !== null && _a !== void 0 ? _a : network) !== null && _b !== void 0 ? _b : "mainnet";
    }
    else
        id = yield (0, methods_1.createRequest)({ transactions, network }, signal);
    return new Promise((resolve, reject) => {
        ...
        (_a = delegate.onRequested) === null || _a === void 0 ? void 0 : _a.call(delegate, { transactions, network, id }, rejectAction);
        (_b = strategy === null || strategy === void 0 ? void 0 : strategy.onRequested) === null || _b === void 0 ? void 0 : _b.call(strategy, { transactions, network, id }, rejectAction);
