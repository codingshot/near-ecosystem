...
class HereWallet {
    constructor({ nodeUrl, networkId = "mainnet", authStorage = new HereKeyStore_1.HereKeyStore(), defaultStrategy = () => new strategy_1.DefaultStrategy(), defaultProvider = here_provider_1.proxyProvider, } = {}) {
        this.authStorage = authStorage;
        this.defaultProvider = defaultProvider;
        this.defaultStrategy = defaultStrategy;
        const signer = new near_api_js_1.InMemorySigner(this.authStorage);
        const rpc = new providers_1.JsonRpcProvider(nodeUrl !== null && nodeUrl !== void 0 ? nodeUrl : `https://rpc.${networkId}.near.org`);
        this.connection = new near_api_js_1.Connection(networkId, rpc, signer);
    }
    get rpc() {
    ...
    signIn(_a) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const data = yield delegate.provider(Object.assign(Object.assign({}, delegate), { network: this.networkId, transactions: [
                        {
                            actions: [
                                {
                                    type: "AddKey",
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                try {
                    ...
                    const data = yield delegate.provider(Object.assign({ transactions: [{ actions, receiverId, signerId }], network: this.networkId }, delegate));
    ...
    signMessage({ signerId, message }) {
        return __awaiter(this, void 0, void 0, function* () {
            const account = yield this.account(signerId);
            const key = yield this.authStorage.getKey(this.networkId, account.accountId);
            if (key == null)
                throw Error("sigin");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                try {
                    ...
                    const data = yield delegate.provider(Object.assign(Object.assign({}, delegate), { transactions: uncompleted, network: this.networkId }));
                    if (data.payload == null || data.account_id == null) {
                        throw Error("Transaction not found, but maybe executed");
                    }
