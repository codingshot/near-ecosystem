...
class QRCodeStrategy {
    ...
    onRequested(request) {
        ...
        this.qrcode = new qrcode_1.default(Object.assign(Object.assign(Object.assign({}, this.themeConfig), this.options), { value: `${network ? this.testnet : this.mainnet}/${request.id}` }));
